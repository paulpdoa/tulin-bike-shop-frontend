                ...
                <div className="md:flex hidden items-center rounded overflow-hidden relative w-full">
                    <div className="relative">
                        ...
                        <article className="absolute left-0 top-0 flex flex-col ml-14 justify-center h-full z-40 text-gray-100">
                            ...
                            <a href='#offer' className="p-2 rounded-md w-3/4 mt-5 border-2 text-center cursor-pointer border-gray-200 hover:bg-gray-200 hover:text-gray-800 transition duration-300">Find out more</a>
                        </article>
                    </div>
